...
static jugadas jugadasGano = {
        jugada(pos(2, 0), 2),jugada(pos(3, 0), 1),jugada(pos(4, 0), 1),
        jugada(pos(0, 1), 3),jugada(pos(1, 1), 3),jugada(pos(2, 1), 3),jugada(pos(4, 1), 1),
        jugada(pos(0, 2), 1),jugada(pos(2, 2), 2),jugada(pos(3, 2), 1),jugada(pos(4, 2), 1),
        jugada(pos(0, 3), 2),jugada(pos(1, 3), 3),jugada(pos(2, 3), 2),jugada(pos(3, 3), 1),jugada(pos(4, 3), 0),
        jugada(pos(1, 4), 2),jugada(pos(3, 4), 1),jugada(pos(4, 4), 0),
};
