...
//Sea t la cantidad de filas del tablero. El peor caso se da cuando el tablero es cuadrado (tengo que recorrer el primer y segundo ciclo for t veces), se jugaron todos los tableros y el último casillero chequeado es una bomba (también jugada). Los dos primeros ciclos for llevan la complejidad a t². Luego, cuando llego a la última posición me fijo en el vector jugadas si la posición se jugó. Ahí empiezo a recorrer el vector de jugadas que tiene t² elementos, y justo en el último se determina que el jugador perdió. Al multiplicarlo, nos queda una función de orden t⁴. Como estamos calculando la complejidad en cuanto a la cantidad t² = n de casilleros del tablero, el orden de la función es n²
